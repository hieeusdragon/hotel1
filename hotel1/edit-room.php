                ...
                <div class="col-md-12">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(empty($title) or empty($post_data) or empty($size) or empty($price) or empty($image1) or empty($image2) or empty($image3) or empty($image4)){
                            ...
                            $insert_query = "UPDATE `rooms` SET `title`='$title',`description`='$post_data',`nb`='$nb',`size`='$size',`price`='$price',`image1`='$image1',`image2`='$image2',`image3`='$image3',`image4`='$image4' WHERE id=$t_id";
