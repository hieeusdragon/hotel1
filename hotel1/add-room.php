...
<?php require_once('header-admin.php');?>
        ...
        <div class="container-fluid body-section container">
            <div class="row">
                <div class="col-md-12">
                    <h2><i class="fa fa-plus-square"></i> Thêm Phòng <small>(Add New Room)</small></h2>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(empty($title) or empty($post_data) or empty($size) or empty($price) or empty($image1) or empty($image2) or empty($image3) or empty($image4)){
                            ...
                            $insert_query = "INSERT INTO rooms (`id`,`title`,`description`,`nb`,`size`,`price`,`image1`,`image2`,`image3`,`image4`) VALUES ($id,'$title','$post_data','$nb','$size','$price','$image1','$image2','$image3','$image4')";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="nb">Số Phòng:*</label>
                                            <input type="text" name="nb" placeholder="Type Size Here (sq. feet)" value="<?php if(isset($title)){echo $nb;}?>" class="form-control">
                                        </div>
